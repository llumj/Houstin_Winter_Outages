...
income_geo <- left_join(texas_cens, income, join_by(GEOID_Data == GEOID))
...
spatial_objects <- list(building, roads, tile_8_5_07, tile_8_6_07, tile_8_5_16, tile_8_6_16, texas_cens, ejscreen)
...
```{r}
# Use st_transform to set crs to Es
diff_rast_mask_poly_3083 <- st_transform(diff_rast_mask_poly, crs = 3083)

# Confirm the new CRS
st_crs(diff_rast_mask_poly_3083)
...
```{r}
roads_200 <- st_buffer(roads, dist = 5000)
